        ...
        <Block factor={factor} offset={offset}>
            <group position={[left ? -alignRight : alignRight, 0, 0]}>
                ...
                >
                    ...
                    <div className='overflow-visible flex flex-col relative mt-56 py-12' tabIndex={index}>
                        <h1 className="absolute top-0 right-0 w-max text-right text-4xl text-blue-200 font-extrabold tracking-tighter">Front-end focused full stack developer. </h1>
                        <dl>
                            <dt className="mt-6 font-extrabold text-gray-200 tracking-tighter">Expertise in</dt>
                            <dd>React</dd>
                            <dd>Django</dd>
                            <dd>Related frameworks </dd>
                            <dt className="mt-6 font-extrabold text-gray-200 tracking-tighter">Currently focusing on</dt>
                            <dd>Node</dd>
                            <dd>Typescript</dd>
                            <dd>WebGL</dd>
                            <dd>Algorithms</dd>
